...
export const metadata: Metadata = {
  ...
  description: "Long-scroll grid of highlighted creative work and experiments."
};
  ...
  return (
    <section className="space-y-10">
      <header className="max-w-3xl space-y-4">
        ...
        <h1 className="text-4xl leading-tight text-ink sm:text-5xl">Creative work and experiments.</h1>
        <p className="max-w-2xl text-sm leading-relaxed text-quiet">
          A long-scroll, open-ended grid sourced from local project notes.
        </p>
      </header>
